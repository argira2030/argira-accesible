...
//     Pensado para insertarse dentro de #argira-zoom-content (map-explorer.js).
...
(function () {
  ...
  // dentro de `container` (pensado para #argira-zoom-content) usando
  // `imageElement` (pensado para #argira-zoom-img, ya cargada en pantalla).
  //
