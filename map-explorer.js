...
//
//  VERSIÓN FINAL CON ARRANQUE SEGURO (boot con requestAnimationFrame)
// ================================================================
...
(function() {
  ...
  // ------------------------------------------------------------------
  // 7. ARRANQUE SEGURO (espera a que canvas y CATALOGUE estén listos)
  // ------------------------------------------------------------------
  (function boot() {
    const canvas = document.getElementById('map');
    ...
    // Todo listo: iniciar el explorador
    initOverlayAndNodes();
