...
(function() {
  ...
  const OBRA_META = {
    ...
    'Dalí · Perfil del tiempo': {
      ...
      audio: "Dali_-_The_Persistence_of_Memory.wav",
    },
    ...
    'Degas · Dancers pink and green': {
      ...
      img: "Degas_-_Dancers_Pink_and_Green.jpg",
    ...
    'Caravaggio · La captura de Cristo': {
      ...
      audio: "Caravaggio_-_The_Taking_of_Christ.wav",
    },
    'Caravaggio · La vocación de San Mateo': {
      ...
      audio: "Caravaggio_-_The_Calling_of_Saint_Matthew.wav",
    },
    'Goya · Fusilamientos 3 de mayo': {
      ...
      audio: "El_Tres_de_Mayo,_by_Francisco_de_Goya,_from_Prado_thin_black_margin.wav",
    },
    'Caravaggio · Narciso': {
      titulo: "Narciso",
      artista: "Caravaggio",
      ...
      audio: "Caravaggio_-_Narcissus.wav",
    },
    'Cézanne · Tulipanes': {
      titulo: "Tulipanes",
      artista: "Paul Cézanne",
