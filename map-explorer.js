// ================================================================
//  ARGIRA · MAP EXPLORER · FASE 2D FINAL (COMPLETO Y CORREGIDO)
//  ================================================================
(function() {
  'use strict';
  ...
  // ------------------------------------------------------------------
  // 2. MODAL (TODAS LAS FUNCIONES, DECLARADAS ANTES DE LA API)
  // ------------------------------------------------------------------
  ...
  // ------------------------------------------------------------------
  // 6. ARRANQUE SEGURO (CON LÍMITE DE INTENTOS)
  // ------------------------------------------------------------------
  let bootAttempts = 0;
  ...
  function boot() {
    ...
    if (!canvas || !catalogue || !catalogue.length) {
      if (bootAttempts > MAX_ATTEMPTS) {
        console.error('❌ ARGIRA explorer: catálogo o canvas no disponibles después de 180 intentos');
        return;
      }
  ...
  // ------------------------------------------------------------------
  // 7. API PÚBLICA (asignación directa, sin envolturas)
  // ------------------------------------------------------------------
