...
(function() {
  ...
  let _currentObra = null;  // obra del CATALOGUE abierta en el modal — necesaria para playAnchor
  ...
  function openModal(meta) {
    ...
    // Guardar la obra del CATALOGUE para construir el commit de sonificación
  ...
  function startListen() {
    ...
    // Sonificación: inicializar/resumir audioCtx si es necesario,
    // igual que hace btn-audio-header. Luego construir commit y disparar playAnchor.
    if (_currentObra && window.playAnchor && window.ensureAudio) {
      const obra = _currentObra;
      window.ensureAudio().then(() => {
        const commit = {
  ...
  function stopListen() {
    ...
    // Detener la fuente de sonificación activa si la hay
