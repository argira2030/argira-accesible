...
(function() {
  ...
  function openModal(meta) {
    ...
    // Reset seguro: no asignar src='' (algunos navegadores disparan onerror inmediato)
    imgEl.onload = null;
    imgEl.onerror = null;
    ...
    if (meta.img) {
      ...
      imgEl.onload  = () => { imgEl.hidden = false; imgEl.classList.add('loaded'); phEl.style.display = 'none'; };
      imgEl.onerror = () => { imgEl.classList.remove('loaded'); imgEl.hidden = true; phEl.textContent = 'imagen no disponible'; };
