...
(function() {
  ...
  const OBRA_META = {
    ...
    'Dalí · Perfil del tiempo': {
      ...
      img: "Dali_-_The_Persistence_of_Memory.jpg",
    ...
    'Caravaggio · La captura de Cristo': {
      ...
      img: "Caravaggio_-_The_Taking_of_Christ.jpg",
    ...
    'Caravaggio · La vocación de San Mateo': {
      ...
      img: "Caravaggio_-_The_Calling_of_Saint_Matthew.jpg",
    ...
    'Goya · Fusilamientos 3 de mayo': {
      ...
      img: "El_Tres_de_Mayo,_by_Francisco_de_Goya,_from_Prado_thin_black_margin.jpg",
    ...
    'Caravaggio · Narciso': {
      ...
      img: "Caravaggio_-_Narcissus.jpg",
      audio: "narciso.wav",
    },
    'Cézanne · Tulipanes': {
      titulo: "Tulipanes",
  ...
  const IMAGE_ALIAS_MAP = {
    ...
    'Caravaggio · Narciso':                  'narciso.jpeg',
    ...
    '1280px-Korenveld_Van_Gogh':             '1000081710.jpg',
  };
  ...
  function initPointerInteraction() {
    ...
    function handlePointerUp(e) {
      ...
      // Un solo toque → anunciar perfil de zona + anclar si el audio está activo.
      // El perfil se anuncia siempre, con o sin audio, porque TalkBack no arrastra:
      // navega tocando zonas y necesita feedback inmediato de cada toque.
      // toPerceptualProfile y _computeSonic viven en index.html (window.*).
      if (typeof window.toPerceptualProfile === 'function' &&
          typeof window._computeSonic === 'function') {
        const sp = window._computeSonic(obra.P1, obra.P2, obra.P3,
                                        obra.P4, obra.P5, obra.P6);
        const perfil = window.toPerceptualProfile(obra.P1, obra.P2,
                                                   obra.P4, sp.decay, obra.P5);
        const srAnnouncer = document.getElementById('sr-announcer');
        if (srAnnouncer) {
          srAnnouncer.textContent = '';
          clearTimeout(window._anchorAnnounceTid);
          window._anchorAnnounceTid = setTimeout(() => {
            // Si setAnchorFromHover va a anunciar también, no duplicar:
            // solo anunciar el perfil aquí si el audio no está activo.
            const audioActive = window.audioCtx && window.audioCtx.state === 'running';
            if (!audioActive) {
              srAnnouncer.textContent = `${meta.titulo}, de ${meta.artista}. ${perfil}`;
            }
          }, 50);
        }
      }
