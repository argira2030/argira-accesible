...
(function() {
  ...
  function startListen() {
    ...
    // Sonificación: si el campo de audio está activo y tenemos la obra,
    // construir el commit y disparar playAnchor igual que haría el mapa.
    if (_currentObra && window.playAnchor) {
