...
(function() {
  ...
  async function startListen() {
    ...
    // lo escucha solo para ocultar el halo del cursor sobre el mapa mientras
    // suena el audio. Cumple el contrato: ningún CustomEvent muta _isListening,
    // _isListening ya cambió arriba y esto es un reflejo hacia fuera.
  ...
  function stopListen() {
    ...
    // index.html vuelve a mostrar el halo del cursor al dejar de sonar.
